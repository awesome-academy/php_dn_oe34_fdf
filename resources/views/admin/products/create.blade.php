...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{trans('messages.create_new_product')}}</div>
                    <div class="card-body">
                        <div>
                            <a href="{{url()->previous()}}">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-9 well well-sm col-md-offset-4 container">
                                    <form action="{{route('product.create')}}" method="post" class="form" enctype="multipart/form-data" role="form">
                                        @csrf
